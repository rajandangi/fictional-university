...
class PetAdoptionTablePlugin
{
  ...
  function __construct()
  {
    ...
    /**
     * admin_post_{action} for logged in users to submit forms
     * admin_post_nopriv_{action} for non-logged in users to submit forms
     *  - 'createpet' is the action name defined in the form template-pets.php
     */
  ...
  function onActivate()
  {
    ...
    /**
     * dbDelta is a WordPress function that examines the current table structure, 
     *  compares it to the desired table structure, and either adds or modifies.
